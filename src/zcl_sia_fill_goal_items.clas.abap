...
CLASS zcl_sia_fill_goal_items IMPLEMENTATION.
  METHOD if_oo_adt_classrun~main.
    ...
    LOOP AT lt_goals ASSIGNING FIELD-SYMBOL(<ls_goal>).
      DO 3 TIMES.
        ls_item-subgoal_id    = |{ sy-datum+4(4) }{ sy-uzeit+2(4) }{ sy-index }|.
        ls_item-goal_id       = <ls_goal>-goal_id.
        ls_item-subgoal_title = |Subgoal { sy-index } for Goal { <ls_goal>-goal_id }|.
        ls_item-subgoal_desc  = |Description for subgoal { sy-index } of goal { <ls_goal>-goal_id }|.
        ls_item-status = 
          COND #( WHEN sy-index = 1 THEN 'C'  " Completed
